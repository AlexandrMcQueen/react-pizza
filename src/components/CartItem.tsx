...
import {minusItem, plusItem, removeProduct} from "../redux/slices/cart/slice";
    ...
    return (
        ...
        <div className="cart__item">
            ...
            <div className="cart__item-count">
                <button disabled={count === 1} ref={minusBtn} onClick={onClickMinus}  className="button button--outline button--circle cart__item-count-minus">
