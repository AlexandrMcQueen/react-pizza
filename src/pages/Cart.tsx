...
export const Cart : React.FC = () => {
    ...
    const {items,totalPrice} = useSelector(cartSelector);
     const clearCartItems = () : any => {
         let answer = window.confirm('Ви впевнені що хочете видалити всі замовлення?');
         if(answer){
                    ...
                    <div className="cart">
                        <div className="cart__top">
                            ...
                            <div className="cart__clear">
                                ...
                                <span onClick={clearCartItems}>Очистити корзину</span>
                            </div>
                        </div>
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Всього піц: <b>{items.length} шт.</b> </span>
